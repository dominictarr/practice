...
#	assert_references(Test::Unit::TestResult,Object,Array,ArgumentError,Proc)
end

def test_non_class_const_included_module_required
	#class references should only return classes.
	assert_references(SomeConstants2,Object,String,DifferentModule::ModuleWithConstants::DoNothing,DifferentModule::AnotherEmptyClass)
end
def test_non_class_const_included_module_required2
	#class references should only return classes.
	assert_references(Test::Unit::TestResult,Object,Array,ArgumentError,Proc,Test::Unit::Util::ProcWrapper)
end
